...
export default function StudentAttendancePage() {
  ...
  useEffect(() => {
    const fetchAttendance = async () => {
      ...
      try {
        // In this system, student user might have studentId in their user object or we use their _id to find Student doc
        // Assuming the API handles finding the student doc from user context or we pass studentId
        // Let's first get student profile to get the internal Student model ID
        const profileRes = await api.get("/auth/profile");
        const studentId = profileRes.data.studentId; // This should be populated in profile
