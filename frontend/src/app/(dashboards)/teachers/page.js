...
import {
  Search, Plus, MoreHorizontal, Loader2, Edit, Trash2, Eye,
} from "lucide-react";
...
export default function TeachersPage() {
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Delete this teacher and their login account permanently?")) {
      try {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button
          onClick={() => { setTeacherToEdit(null); setIsModalOpen(true); }}
              ...
              <AnimatePresence>
                {filtered.map((teacher) => (
                  ...
                  >
                    ...
                    <TableCell>{teacher.experience} yr{teacher.experience !== 1 ? "s" : ""}</TableCell>
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem className="p-0">
                            <Link href={`/teachers/${teacher._id}`} className="flex w-full items-center px-2 py-1.5 cursor-pointer">
                              <Eye className="w-4 h-4 mr-2" /> View Profile
                            </Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem
                            onClick={() => { setTeacherToEdit(teacher); setIsModalOpen(true); }}
                          >
